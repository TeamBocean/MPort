...
const Hero = () => {
  ...
  return (
    <section
      className="flex items-center justify-center bg-white dark:bg-[#161616] min-h-screen"
      id="home"
    >
      <div className="grid max-w-screen-xl px-4 py-8 lg:py-16 lg:grid-cols-12 gap-8 w-full">
        <div className="lg:col-span-6 xl:col-span-7 place-self-center">
          ...
          <p className="max-w-2xl mb-6 font-light text[24px] text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-white">
          ...
          <div className="flex gap-4">
            <a className="Btn" href="https://github.com/mahmoudal99" target="_blank" rel="noreferrer">
              <span className="BG"></span>
              <span className="svgContainer dark:border-white">
                <svg fill="currentColor" viewBox="0 0 496 512" height="1.6em" className="dark:text-white">
            ...
            <a className="Btn" href="https://twitter.com/mahmoud_alm99" target="_blank" rel="noreferrer" >
              <span className="BG"></span>
              <span className="svgContainer dark:border-white">
                <svg fill="currentColor" viewBox="0 0 496 512" height="1.6em" className="dark:text-white">
          ...
          <a className="btn-content dark:border-white" href="#contact">
              <span className="btn-title dark:text-white">Lets Connect</span>
              <span className="icon-arrow dark:text-white">
                <svg
                  width="43px"
                  height="43px"
                  viewBox="0 0 66 43"
            ...
            <a
            href={pdfFile}
            className="dark:border-white cursor-pointer group relative flex gap-1.5 d-button dark:text-white"
            download="Sample.pdf"
          >
            Download CV
            <svg
