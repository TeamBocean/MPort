...
const About = () => {
  ...
  const narrativeText =
    "With Over 3 Years Of Experience In The Tech Industry, I've Had The Privilege Of Working With Over 20 Clients Worldwide And Completing More Than 30 Projects. I Hold A Bachelor Of Science Degree And Continually Strive To Learn And Grow In My Field.";
    ...
    >
      <div className="max-w-4xl mx-auto mt-[100px]" id="about">
        <div className="text-center">
          <h2 className="text-3xl font-semibold mb-4 text-left title-animate">
            About Me
          </h2>
        ...
        >
          ...
          {["Experience", "Clients", "Projects", "Education"].map(
            (item, index) => (
              <motion.div
                whileHover="hover"
